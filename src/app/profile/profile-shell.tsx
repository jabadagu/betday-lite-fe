          ...
          <Box className='flex flex-wrap justify-center gap-4 pt-2 sm:justify-start'>
            <Box className='flex items-center gap-1.5 text-xs'>
              ...
              <Typography variant='body3' className='text-secondary'>
                {copy.totalBets}:{" "}
                <span className='font-bold text-primary'>{totalBets}</span>
              </Typography>
            </Box>
            <Box className='flex items-center gap-1.5 text-xs'>
              <Typography variant='body3' className='text-secondary'>
      ...
      <Card>
        ...
        <Box className='flex flex-wrap gap-3'>
          <Button
            ...
            <Moon className='h-4 w-4' /> {copy.dark}
          </Button>
          <Button
            ...
            <Sun className='h-4 w-4' /> {copy.light}
          </Button>
          <Box className='w-px bg-border-primary mx-1 hidden sm:block' />
          <Button
            variant={locale === Locale.ES ? "primary" : "outline"}
            size='sm'
            rounded='lg'
